...
function NotificationPreferencePanel({ preference, onChange }: { preference: NotificationPreference; onChange: (patch: Partial<NotificationPreference>) => void }) {
  return (
...
function NotificationItem({ notification, onRead }: { notification: NotificationEntry; onRead: (notificationId: string) => void }) {
  return (
    <List.Item
...
const NotificationCenter: React.FC = () => {
  ...
  const { notifications, preference, loading, fetchNotifications, markRead, markAllRead, clearNotifications, updatePreference } = useNotifications();
